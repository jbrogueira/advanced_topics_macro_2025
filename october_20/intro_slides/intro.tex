...
\begin{frame}
    ...
    \begin{itemize}
        \item AI system by Google DeepMind 
            \vspace{0.5em}
        \item Predicts 3D protein structures from amino acid sequences
            \vspace{0.5em}
    \end{itemize}
    ...
    2024 Nobel Prize in Chemistry awarded to 
    %
    \begin{itemize}
        \item Demis Hassabis 
        \item John Jumper 
